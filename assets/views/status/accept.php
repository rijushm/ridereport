...
<body>
	...
	<section class="w-full flex justify-center items-center flex-col text-center p-6">
		...
		<div class="mb-6">
			<lottie-player src="https://assets4.lottiefiles.com/packages/lf20_nacl7qp0.json"  background="transparent"  speed="1"  style="width: 100px; height: 100px;"  loop autoplay></lottie-player>
		</div>
		<h2 class="text-4xl font-bold mb-2">Request Approved</h2>
